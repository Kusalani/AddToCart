...
import com.example.onlinehardwarestore.activities.NavCategoryActivity;
...
public class NavCategoryAdapter extends RecyclerView.Adapter<NavCategoryAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.nav_cat_name);
            imageView = itemView.findViewById(R.id.nav_cat_description);
            imageView = itemView.findViewById(R.id.nav_cat_discount);
        }
    }
}
